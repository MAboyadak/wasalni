...
class TripsController extends Controller
{
    ...
    {
        $user = auth()->user();
        $DEFAULT_URL = 'https://wasalni-225100.firebaseio.com/'; ## https://taxi-c503a.firebaseio.com/
        $DEFAULT_TOKEN = 'xLUBPXPGMt1oOs4RD0AH72riFfdewYnmqPteB26z'; ## QJsf6NkBs2bCRrN15pkt7TI5NK8p4trQXnFOGjxq
